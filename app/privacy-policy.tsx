      ...
      >
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedText style={styles.text}>
            We collect information you provide directly to us, such as when you create an account, place an order, or contact us. This may include your name, email address, phone number, and payment information.
          </ThemedText>
        </ThemedView>
        ...
        <ThemedView style={styles.section}>
          <ThemedText style={styles.sectionTitle}>5. Location Services</ThemedText>
          <ThemedText style={styles.text}>
            We may collect location information to help you find nearby restaurants and provide location-based services. You can control location permissions in your device settings.
          </ThemedText>
        </ThemedView>

        <ThemedView style={styles.section}>
          <ThemedText style={styles.sectionTitle}>6. Cookies and Tracking</ThemedText>
          <ThemedText style={styles.text}>
        ...
        <ThemedView style={styles.section}>
          <ThemedText style={styles.sectionTitle}>7. Third-Party Services</ThemedText>
          <ThemedText style={styles.text}>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedText style={styles.text}>
            If you have any questions about this Privacy Policy, please contact us at privacy@savedfeast.com
          </ThemedText>
        </ThemedView>
      </ScrollView>
    </SafeAreaView>
